...
### References
- **[Component Patterns](Codex%20config/Skills/writing-plans/references/component-patterns.md)** — Ready-to-use BOS component patterns (cards, buttons, inputs, modals, badges, animations)
