...
> **Attribution**: Interaction patterns, animation timing, and form UX guidelines adapted from [Vercel's Web Interface Guidelines](https://vercel.com/design/guidelines), synthesized with BOS brand principles. Skill structure informed by [Codex](https://github.com/anthropics/Codex).
...
- Skill structure informed by [Codex](https://github.com/anthropics/Codex)
