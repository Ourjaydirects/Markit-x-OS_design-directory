# BOS 3.0 - Codex Development Guide

## Project Overview
Brand Operating System (BOS) 3.0 - AI-powered brand management platform built with Next.js 16+, React 19, TypeScript, and Tailwind CSS. Features multi-model AI chat (Codex, Perplexity), brand knowledge systems, and collaborative workspaces.
...
- **State**: Zustand
- **Database**: Supabase
- **AI**: Anthropic SDK (Codex), Perplexity API
...
The `.Codex/` directory is organized for Codex CLI compatibility:

```
.Codex/
├── AGENTS.md                    # This file (CLI required at root)
...
This project uses MCP servers to extend Codex's capabilities with external tools and services.
